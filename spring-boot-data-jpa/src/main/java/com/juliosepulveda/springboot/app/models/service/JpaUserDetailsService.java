...
import com.juliosepulveda.springboot.app.models.dao.IUsuarioDao;
import com.juliosepulveda.springboot.app.models.entity.Role;
...
public class JpaUserDetailsService implements UserDetailsService {
	...
	public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
		...
		if(usuario == null) {
			...
			throw new UsernameNotFoundException("Username '" + username + "' no exixte en el sistema!");
		}
